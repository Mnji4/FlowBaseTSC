...
from utils.buffer import ReplayBufferTime,WeightedReplayBuffer
...
if __name__ == '__main__':
    ...
    parser.add_argument("--method",default='Flow', help="Name of environment")
