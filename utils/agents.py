...
from utils.policies import DiscretePolicy, GruDiscretePolicy

class GruAttentionAgent(object):
    """
    ...
    def __init__(self, num_in_pol, num_out_pol, hidden_dim=64,
        ...
        """
        self.policy = GruDiscretePolicy(num_in_pol, num_out_pol,
                                     hidden_dim=hidden_dim,
                                     onehot_dim=onehot_dim)
        self.target_policy = GruDiscretePolicy(num_in_pol,
                                            num_out_pol,
                                            hidden_dim=hidden_dim,
                                            onehot_dim=onehot_dim)
