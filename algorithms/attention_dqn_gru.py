...
from utils.critics import GruAttentionSingleCritic
...
class AttentionDDQN(object):
    ...
    def __init__(self, agent_init_params, sa_size,
        ...
        self.critic = GruAttentionSingleCritic(sa_size[:5], hidden_dim=critic_hidden_dim,
                                      attend_heads=attend_heads, norm_in = False)
        self.target_critic = GruAttentionSingleCritic(sa_size[:5], hidden_dim=critic_hidden_dim,
                                             attend_heads=attend_heads, norm_in = False)
